package dam.jsoup.updatereport.updatreport.util.logAop.impl;

import com.alibaba.fastjson.JSON;
import dam.jsoup.updatereport.updatreport.util.logAop.OperationLog;
import dam.jsoup.updatereport.updatreport.util.logAop.OperationLogDetail;
...
public class LogAspect {
    @Pointcut("@annotation(dam.jsoup.updatereport.updatreport.util.logAop.OperationLogDetail)")
